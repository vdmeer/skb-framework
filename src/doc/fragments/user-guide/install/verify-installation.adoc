...
Note: There is a bug in the original version 0.0.4.
This version will show an error message instead of the version information.
...
=== Let teh Framework validate itself
