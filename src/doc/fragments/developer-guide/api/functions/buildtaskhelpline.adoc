...
----
   ...
   -f | --file FILE              file to open in viewer
----
endif::[]
ifdef::backend-html5[]
...
----
include::{skb-site-target-dir}/adoc-task-help/clean--help--pdf.adoc[tags=helpline]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-task-help/clean--help--adoc.adoc[tags=helpline]
----
endif::[]
