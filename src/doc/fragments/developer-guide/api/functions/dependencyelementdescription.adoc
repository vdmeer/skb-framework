...
_void DependencyElementDescription( $1 )_ - prints general description for dependencies.

This function prints text describing dependencies in general.
The text is formatting for the print mode _$1_.
The actual text is taken from _CONFIG_MAP["MANUAL_SRC"]}/elements/dependencies_, with _$1_ as file extension
...
----
DependencyElementDescription ansi
----
