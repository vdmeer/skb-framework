...
_void TaskElementDescription( $1 )_ - prints general description for scenarios.

This function prints text describing scenarios in general.
The text is formatting for the print mode _$1_.
The actual text is taken from _CONFIG_MAP["MANUAL_SRC"]}/elements/scenarios_, with _$1_ as file extension
...
----
ScenarioElementDescription ansi
----
