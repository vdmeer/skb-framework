...
This function prints the error code name (padded number), the tag line, and a padding in one line.
...
* _string_, the line with a leading space, error code name, tag line, and padding
