...
_void ParameterElementDescription( $1 )_ - prints general description for parameters.

This function prints text describing parameters in general.
The text is formatting for the print mode _$1_.
The actual text is taken from _CONFIG_MAP["MANUAL_SRC"]}/elements/parameters_, with _$1_ as file extension
...
----
ParameterElementDescription ansi
----
