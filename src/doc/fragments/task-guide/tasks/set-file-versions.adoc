...
----
   *-b* | *--build-file* <span style="color: #5C5CFF">FILE</span>   ANT build file
   *-d* | *--directory* <span style="color: #5C5CFF">DIR</span>     start directory with source files
   *-h* | *--help*              print help screen and exit
   *-m* | *--macro-file* <span style="color: #5C5CFF">FILE</span>   ANT macro file
   *-v* | *--version* <span style="color: #5C5CFF">VERSION</span>   new version string
----
