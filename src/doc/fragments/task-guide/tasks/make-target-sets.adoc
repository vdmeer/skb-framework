...
----
   options
   *-c* | *--clean*            cleans target set(s) (all or given ID)
   *-h* | *--help*             print help screen and exit
   *-l* | *--list*             list target sets
----
...
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
   *-t* | *--targets* <span style="color: #5C5CFF">TARGETS</span>  list of targets, separated by comma
----
...
----
   filters
   *-A* | *--all*              all target sets
   *-i* | *--id* <span style="color: #5C5CFF">ID</span>            target set identifier for building
----
...
----
include::{skb-ts.id}/../skb-site.id[tags=ts-id]
----
