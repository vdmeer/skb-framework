...
* _install_ - include scenarios that are defined for the `install` application mode flavor
...
----
   filters
   -I | --install           include scenarios for application mode flavor 'install'
...
----
   filters
   -I | --install           include tasks for application mode flavor 'install'
