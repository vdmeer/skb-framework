...
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--pdf.adoc[tags=options]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--adoc.adoc[tags=options]
----
endif::[]
...
[source%nowrap,bash,indent=0,subs="attributes"]
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--pdf.adoc[tags=options-target]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--adoc.adoc[tags=options-target]
----
endif::[]
...
[source%nowrap,bash,indent=0,subs="attributes"]
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--pdf.adoc[tags=targets]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-screens/build-cache--help--adoc.adoc[tags=targets]
----
endif::[]
