...
----
include::{skb-site-target-dir}/adoc-screens/task-help/setting--help--pdf.adoc[tags=options]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-screens/task-help/setting--help--adoc.adoc[tags=options]
----
endif::[]
...
[source%nowrap,bash,indent=0,subs="attributes"]
----
include::{skb-site-target-dir}/adoc-screens/task-help/setting--help--pdf.adoc[tags=change-options]
----
endif::[]
ifdef::backend-html5[]
[source%nowrap,bash,indent=0,subs="attributes,quotes"]
----
include::{skb-site-target-dir}/adoc-screens/task-help/setting--help--adoc.adoc[tags=change-options]
----
endif::[]
