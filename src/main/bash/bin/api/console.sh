...
ConsoleCalculate(){
    ...
    CONSOLE_MAP["ES_PADDING"]=6
    CONSOLE_MAP["ES_STATUS_LENGHT"]=16
    CONSOLE_MAP["ES_LINE_MIN_LENGTH"]=49
    CONSOLE_MAP["ES_COLUMNS_PADDED"]=$((${CONSOLE_MAP["COLUMNS"]} - 2))
    CONSOLE_MAP["ES_DESCRIPTION_LENGTH"]=$((${CONSOLE_MAP["ES_COLUMNS_PADDED"]} - ${CONSOLE_MAP["ES_PADDING"]} - ${CONSOLE_MAP["ES_STATUS_LENGHT"]} - 1))
