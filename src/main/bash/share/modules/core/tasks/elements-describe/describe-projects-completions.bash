...
##
## describe-projects - auto completion
##
...
function __skb_task_describe_projects_completions(){
    local retval="$(__skb_task_describe_projects_words)"
    if [[ -n "${retval}" ]]; then COMPREPLY=($(compgen -W "${retval}" -- "${COMP_WORDS[COMP_CWORD]}")); fi
}
complete -F __skb_task_describe_projects_completions describe-projects
