...
##
## describe-dirs - task that describes dirs
##
...
Clioptions add option filter-id        describe directory
...
if [[ "${FW_INSTANCE_CLI_SET["id"]}" == "yes" ]]; then
    Test existing dir id "${FW_INSTANCE_CLI_VAL["id"]}"
...
############################################################################################
##
## print dirs descriptions
##
############################################################################################
Print dir descriptions "${arr}"
