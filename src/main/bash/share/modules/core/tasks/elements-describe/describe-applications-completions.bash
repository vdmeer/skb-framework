...
##
## describe-applications - auto completion
##
...
function __skb_task_describe_applications_completions(){
    local retval="$(__skb_task_describe_applications_words)"
    if [[ -n "${retval}" ]]; then COMPREPLY=($(compgen -W "${retval}" -- "${COMP_WORDS[COMP_CWORD]}")); fi
}
complete -F __skb_task_describe_applications_completions describe-applications
