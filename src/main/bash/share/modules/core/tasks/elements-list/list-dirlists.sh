...
Cli add option filter-origin    "directory lists"
Cli add option filter-requested "directory lists"
Cli add option filter-status    "directory lists"
Cli add option filter-tested    "directory lists"
Cli add option filter-not-core  "directory lists"
