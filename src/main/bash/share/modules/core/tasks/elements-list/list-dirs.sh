...
Cli add option filter-origin    directories
Cli add option filter-requested directories
Cli add option filter-status    directories
Cli add option filter-tested    directories
Cli add option filter-not-core  directories
