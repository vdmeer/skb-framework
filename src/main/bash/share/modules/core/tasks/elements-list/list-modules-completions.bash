...
function __skb_task_list_modules_completions(){
    local retval="$(__skb_task_list_modules_words)"
    if [[ -n "${retval}" ]]; then COMPREPLY=($(compgen -W "${retval}" -- "${COMP_WORDS[COMP_CWORD]}")); fi
}
complete -F __skb_task_list_modules_completions list-modules
