...
FW_COMPONENTS_TABLE_EXTRA["Projects"]="MD X S T D B U"
...
FW_COMPONENTS_TABLE_EXTRA["Scenarios"]="MD X S T D B U"
...
FW_COMPONENTS_TABLE_EXTRA["Sites"]="MD X"
...
FW_COMPONENTS_TABLE_EXTRA["Tasks"]="MD X R S T D B U"
