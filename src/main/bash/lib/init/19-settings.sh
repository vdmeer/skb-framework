...
Add object setting MESSAGE_CODE_COUNT   with    0                                           "number of collected messages"
...
Add object setting RETEST_COMMANDS      with    no                                          "changes behavior verifying applications and depdencies"
Add object setting RETEST_FS            with    no                                          "changes behavior verifying directories and files"
