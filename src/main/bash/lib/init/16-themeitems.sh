...
Add object themeitem elementExexYesFmt      "format for execute show status value 'yes'"
Add object themeitem elementExexYesChar     "character for execute show status value 'yes'"
Add object themeitem elementExexNoFmt       "format for execute show status value 'no'"
Add object themeitem elementExexNoChar      "character for execute show status value 'no'"
...
Add object themeitem execEndWarningFmt      "format for warning status"
