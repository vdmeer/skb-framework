...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_SCN_LONG FW_ELEMENT_SCN_ORIG FW_ELEMENT_SCN_MODES FW_ELEMENT_SCN_PATH FW_ELEMENT_SCN_PATH_TEXT FW_ELEMENT_SCN_SHOW_EXEC FW_ELEMENT_SCN_REQUIRED_APP FW_ELEMENT_SCN_REQUIRED_DEP FW_ELEMENT_SCN_REQUIRED_PAR FW_ELEMENT_SCN_REQUIRED_TSK FW_ELEMENT_SCN_REQUIRED_FILE FW_ELEMENT_SCN_REQUIRED_FILELIST FW_ELEMENT_SCN_REQUIRED_DIR FW_ELEMENT_SCN_REQUIRED_DIRLIST"
...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_SIT_LONG FW_ELEMENT_SIT_ORIG FW_ELEMENT_SIT_PATH FW_ELEMENT_SIT_PATH_TEXT FW_ELEMENT_SIT_FILE FW_ELEMENT_SIT_SHOW_EXEC FW_ELEMENT_SIT_REQUIRED_APP FW_ELEMENT_SIT_REQUIRED_DEP FW_ELEMENT_SIT_REQUIRED_PAR FW_ELEMENT_SIT_REQUIRED_TSK FW_ELEMENT_SIT_REQUIRED_FILE FW_ELEMENT_SIT_REQUIRED_FILELIST FW_ELEMENT_SIT_REQUIRED_DIR FW_ELEMENT_SIT_REQUIRED_DIRLIST"
