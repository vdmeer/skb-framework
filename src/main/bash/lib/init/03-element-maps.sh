...
declare -A FW_ELEMENT_DEP_REQNUM    ## [long]="requirement number"
...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_DEP_LONG FW_ELEMENT_DEP_DECMDS FW_ELEMENT_DEP_DECPHA FW_ELEMENT_DEP_CMD FW_ELEMENT_DEP_REQNUM FW_ELEMENT_DEP_REQUIRED_DEPENDENCIES"
...
declare -A FW_ELEMENT_MDS_REQNUM    ## [long]="requirement number"
...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_MDS_LONG FW_ELEMENT_MDS_ACR FW_ELEMENT_MDS_DECPHA FW_ELEMENT_MDS_PATH FW_ELEMENT_MDS_REQNUM FW_ELEMENT_MDS_REQUIRED_MODULES"
...
declare -A FW_ELEMENT_PRJ_REQNUM    ## [long]="requirement number"
...
declare -A FW_ELEMENT_SCN_REQNUM    ## [long]="requirement number"
...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_SCN_LONG FW_ELEMENT_SCN_DECMDS FW_ELEMENT_SCN_DECPHA FW_ELEMENT_SCN_MODES FW_ELEMENT_SCN_PATH FW_ELEMENT_SCN_PATH_TEXT FW_ELEMENT_SCN_SHOW_EXEC FW_ELEMENT_SCN_REQUIRED_APP FW_ELEMENT_SCN_REQUIRED_TSK FW_ELEMENT_SCN_REQNUM"
...
declare -A FW_ELEMENT_SCR_REQNUM    ## [long]="requirement number"
...
declare -A FW_ELEMENT_SCR_REQUIRED_FILE         ## [long]="required files, normal list"
declare -A FW_ELEMENT_SCR_REQUIRED_FILELIST     ## [long]="required file lists, normal list"
declare -A FW_ELEMENT_SCR_REQUIRED_DIR          ## [long]="required directories, normal list"
declare -A FW_ELEMENT_SCR_REQUIRED_DIRLIST      ## [long]="required directory lists, normal list"

FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_SCR_LONG FW_ELEMENT_SCR_DECMDS FW_ELEMENT_SCR_DECPHA FW_ELEMENT_SCR_MODES FW_ELEMENT_SCR_PATH FW_ELEMENT_SCR_PATH_TEXT FW_ELEMENT_SCR_RDIR FW_ELEMENT_SCR_SHOW_EXEC FW_ELEMENT_SCR_REQUIRED_APP FW_ELEMENT_SCR_REQUIRED_DEP FW_ELEMENT_SCR_REQUIRED_PAR FW_ELEMENT_SCR_REQUIRED_TSK FW_ELEMENT_SCR_REQUIRED_FILE FW_ELEMENT_SCR_REQUIRED_FILELIST FW_ELEMENT_SCR_REQUIRED_DIR FW_ELEMENT_SCR_REQUIRED_DIRLIST FW_ELEMENT_SCR_REQNUM"
FW_RUNTIME_MAPS_MEDIUM+=" FW_ELEMENT_SCR_STATUS FW_ELEMENT_SCR_STATUS_COMMENTS"
...
declare -A FW_ELEMENT_SIT_REQNUM    ## [long]="requirement number"
...
FW_RUNTIME_MAPS_SLOW+=" FW_ELEMENT_SIT_LONG FW_ELEMENT_SIT_DECMDS FW_ELEMENT_SIT_DECPHA FW_ELEMENT_SIT_PATH FW_ELEMENT_SIT_PATH_TEXT FW_ELEMENT_SIT_RDIR FW_ELEMENT_SIT_SHOW_EXEC FW_ELEMENT_SIT_REQUIRED_APP FW_ELEMENT_SIT_REQUIRED_DEP FW_ELEMENT_SIT_REQUIRED_PAR FW_ELEMENT_SIT_REQUIRED_TSK FW_ELEMENT_SIT_REQUIRED_FILE FW_ELEMENT_SIT_REQUIRED_FILELIST FW_ELEMENT_SIT_REQUIRED_DIR FW_ELEMENT_SIT_REQUIRED_DIRLIST FW_ELEMENT_SIT_REQNUM"
...
declare -A FW_ELEMENT_TSK_REQNUM    ## [long]="requirement number"
