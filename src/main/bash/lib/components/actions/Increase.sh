...
function Increase() {
    ...
    shift; case "${cmd1}" in
        ...
        phase)
            ...
            case "${cmd2}-${cmd3}" in
                error-count | warning-count) __skb_internal_alter_phase_counts increase ${cmd2}-${cmd3} ${id} ;;
        ...
        error | warning)
            ...
            case "${cmd1}-${cmd2}" in
                ...
                error-count | warning-count)
                    __skb_internal_alter_phase_counts increase ${cmd1}-${cmd2} ${FW_OBJECT_SET_VAL["CURRENT_PHASE"]} ;;
