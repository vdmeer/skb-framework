        ...
        4d | ansi | available | defval | element | exec | execution | has-value | help | is-set | list | paragraph | phase | requested | status | table | tagline | themed)
            ...
            case "${cmd1}-${cmd2}" in
                ...
                4d-number)
                    ...
                    format0="${1}"; format1="${2}"; format100="${3}"; format10000="${4}"; padChar=${6:-" "}
                    if [[ "${5}" == 0 || "${5}" =~ ^[1-9][0-9]*$ ]]; then
                        number="${5}"
                    else
                        IFS=" " read -a numberArr <<< "${5}"; unset IFS
                        number="${#numberArr[@]}"
                    fi
                ...
                has-value-char)
                    if [[ -n "${1:-}" ]]; then printf "${FW_INSTANCE_TABLE_CHARS["charXHasValue-${format}"]}"; else printf "${FW_INSTANCE_TABLE_CHARS["charXHasNoValue-${format}"]}"; fi ;;
                is-set-char)
                    if [[ "${#}" -lt 1 ]]; then Report process error "${FUNCNAME[0]}" "${cmdString2}" E801 1 "$#"; return; fi
                    if [[ "${1}" == "yes" ]]; then printf "${FW_INSTANCE_TABLE_CHARS["charXIsSet-${format}"]}"; else printf "${FW_INSTANCE_TABLE_CHARS["charXIsNotSet-${format}"]}"; fi ;;
                phase-char)
                    if [[ "${#}" -lt 1 ]]; then Report process error "${FUNCNAME[0]}" "${cmdString2}" E801 1 "$#"; return; fi
                    case ${1} in
                            ...
                            table-extras-for)
                                ...
                                case ${type} in
                                    ...
                                    phase)
                                        ...
                                        printf " ";  Format 4d number numMessage0Fmt numMessage1Fmt numMessage100Fmt numMessage10000Fmt "${FW_OBJECT_PHA_MSGCOD[${id}]:-}" ;;
                                    ...
                                    application)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt numReqin1Fmt numReqin100Fmt numReqin10000Fmt "${FW_ELEMENT_APP_REQUESTED[${id}]:-}"
                                    ...
                                    dependency)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_DEP_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_DEP_REQOUT_NUM[${id}]}
                                    ...
                                    dirlist)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt numReqin1Fmt numReqin100Fmt numReqin10000Fmt "${FW_ELEMENT_DLS_REQUESTED[${id}]:-}"
                                    ...
                                    dir)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt numReqin1Fmt numReqin100Fmt numReqin10000Fmt "${FW_ELEMENT_DIR_REQUESTED[${id}]:-}"
                                    ...
                                    filelist)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt numReqin1Fmt numReqin100Fmt numReqin10000Fmt "${FW_ELEMENT_FLS_REQUESTED[${id}]:-}"
                                    ...
                                    file)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt numReqin1Fmt numReqin100Fmt numReqin10000Fmt "${FW_ELEMENT_FIL_REQUESTED[${id}]:-}"
                                    ...
                                    module)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_MDS_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_MDS_REQOUT_NUM[${id}]}
                                    ...
                                    parameter)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_PAR_REQUESTED[${id}]:-}"
                                    ...
                                    project)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_PRJ_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_PRJ_REQOUT_NUM[${id}]}
                                    ...
                                    scenario)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_SCN_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_SCN_REQOUT_NUM[${id}]}
                                    ...
                                    script)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_SCR_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_SCR_REQOUT_NUM[${id}]}
                                    ...
                                    site)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_SIT_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_SIT_REQOUT_NUM[${id}]}
                                    ...
                                    task)
                                        ...
                                        printf " ";  Format 4d number numReqin0Fmt  numReqin1Fmt  numReqin100Fmt  numReqin10000Fmt "${FW_ELEMENT_TSK_REQUESTED[${id}]:-}"
                                        printf " ";  Format 4d number numReqout0Fmt numReqout1Fmt numReqout100Fmt numReqout10000Fmt ${FW_ELEMENT_TSK_REQOUT_NUM[${id}]}
                            ...
                            table-legend-for)
                                ...
                                case ${type} in
                                    ...
                                    phase)
                                        ...
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-phase-numbers-${format}"]}" ;;
                                    setting)
                                    ...
                                    application)
                                        ...
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-phases-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-reqin-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-status-${format}"]}" ;;
                                    dependency)
                                        printf " properties:  (MD/P) declaring MOdule (acronym) and Phase\n"
                                        ...
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-phases-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-reqin-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-reqout-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-status-${format}"]}" ;;
                                    ...
                                    option)
                                        ...
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-isset-${format}"]}"
                                        printf "${FW_INSTANCE_TABLE_STRINGS["legend-hasvalue-${format}"]}" ;;
                                    parameter)
                                        printf " properties:  (MD/P) declaring MOdule (acronym) and Phase\n"
