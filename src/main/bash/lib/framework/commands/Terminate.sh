...
##
## Terminate - command to terminate the framework with cleanup and extra prints
##
...
FW_TAGS_COMMANDS["Terminate"]="command to terminate the framework with cleanup and extra prints"
