...
##
## Load - command to load something
##
...
FW_TAGS_COMMANDS["Load"]="command to load something"
...
##TODO message about no modules known - do search
                ...
                framework-sources)
                    for file in ${SF_HOME}/lib/framework/{commands,elements,objects,instances}/*.sh; do source ${file}; done ;;
