...
##
## Init/Messages - main messages, errors and warnings
##
...
Add Object Message E844 0 "did not find GNU (Extended) getopt"                                  ""      "${SF_HOME}/lib/text/messages" "##description"

Add Object Message E847 1 "missing core dependency '##ARG1##' from 'core-utils'"                ""      "${SF_HOME}/lib/text/messages" "##description"
Add Object Message E848 1 "missing important dependency '##ARG1##'"                             ""      "${SF_HOME}/lib/text/messages" "##description"
