...
Add object themeitem listHeadFmt        "element/object list: format used for the list heading"
Add object themeitem listNameFmt        "element/object list: format used for the object/element name"
Add object themeitem listSeparator      "element/object list: string separating name and description"
Add object themeitem listDescrFmt       "element/object list: format used for the object/element description"
Add object themeitem listValueFmt       "element/object list: format used for the object/element values"
Add object themeitem listArgFmt         "element/object list: format used for the argument (option/clioption)"
Add object themeitem listCatFmt         "(CLI) option list: format used for categories, other than 'Options'"

Add object themeitem tableHeadFmt       "element/object table: format used for the table head row"
Add object themeitem tableNameFmt       "element/object table: format used for the object/element name"
Add object themeitem tableSeparator     "element/object table: string separating name and description"
Add object themeitem tableDescrFmt      "element/object table: format used for the object/element description"
Add object themeitem tableValueFmt      "element/object table: format used for the object/element values"
Add object themeitem tableOriginFmt     "element/object table: format for origin string"
Add object themeitem tableSourceFmt     "element/object table: format for source string"
Add object themeitem tableArgFmt        "element/object table: format used for the argument (option/clioption)"

Add object themeitem describeNameFmt    "element/object describe: format used for the object/element name"
Add object themeitem describeSeparator  "element/object describe: string separating name and description"
Add object themeitem describeDescrFmt   "element/object describe: format used for the object/element description"
Add object themeitem describeArgFmt     "element/object describe: format used for the argument (option/clioption)"
