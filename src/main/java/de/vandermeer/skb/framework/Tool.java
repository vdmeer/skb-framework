...
public class Tool {
    ...
    public static AP_Context CONTEXT_L1 = new AP_Context().setWidth(74).setAlignment(TextAlignment.JUSTIFIED_LEFT)
            .setTextLeftMargin(4);

    /** The paragraph context with all settings. */
    public static AP_Context CONTEXT_L2 = new AP_Context().setWidth(70).setAlignment(TextAlignment.JUSTIFIED_LEFT)
            .setTextLeftMargin(8);
